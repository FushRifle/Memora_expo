...
// Updated SVGs with modern blue (#1976d2)
const brainSvg = `
    ...
    return (
        ...
        >
            <TouchableRipple
                onPress={handlePress}
                borderless
                rippleColor="#1976d220"
                style={{ borderRadius: 20 }}
            >
                <YStack>
                    {/* Top section with brain */}
                    <XStack padding="$4" ai="center">
                        <Stack
                            width={90}
                            height={90}
                            borderRadius={45}
                        ...
                        <YStack flex={1} space="$2">
                            <H4 fontWeight="700" color="#1976d2" style={{ fontSize: 20 }}>
                                Your Learning Companion
                            </H4>
                            <Paragraph color="#6e6e6e" fontSize="$4">
                    ...
                    {/* Action button */}
                    <XStack jc="flex-end" px="$4" py="$3">
                        <Button
                            backgroundColor="#1976d2"
                            borderRadius={22}
                            height={42}
                            iconAfter={<ChevronRight size={18} color="white" />}
                            onPress={handlePress}
